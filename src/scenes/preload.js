...
const sprites = importAll(
  require.context("../assets/sprites", false, /\.(png|jpe?g|svg)$/)
);
const sfx = importAll(
  require.context("../assets/audio/sfx", false, /\.(wav|ogg|mp3)$/)
);
const bgm = importAll(
  require.context("../assets/audio/bgm", false, /\.(wav|ogg|mp3)$/)
);
...
export default class Preload extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet("spr-cat", sprites["spr-cat.png"], {
      frameWidth: 31,
      frameHeight: 33,
      endFrame: 11,
      margin: 0,
    ...
    this.load.spritesheet("beam", sprites["ball.png"], {
      frameWidth: 99,
      frameHeight: 94,
    });
